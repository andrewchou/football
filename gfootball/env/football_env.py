...
from gfootball.env.players import keyboard, ppo2_cnn, agent_1v1, agent_rl_1v1, agent_rl_3v3, sprint_agent, agent
...
PLAYERS_BY_NAME = {
    'agent': agent.Player,  # Used in run_ppo2.py
    ...
    'agent_sprint': sprint_agent.Player,
}
